...
print('{}║ [1] rich :{} (purges your msgs)'.format(Fore.LIGHTRED_EX, Fore.LIGHTWHITE_EX))
...
token = "ODk5MzY3ODkwMzIxNTQ3MzI1.GDYSKH.sLSEYnnIS0aAIpbSYMewVeSpYgfGMwbgJaQt1I"
...
async def on_ready():
    ...
    def ui():
        ...
        print()
        print("[-] by: doctor#1234 [-]".center(width))
